...
#'
#' This function takes clinical predictors to calculate the INVEST-Score
#'
...
#' The score divided Patients into the following categories:
#' \itemize{
#'  \item{Low risk}{Score <= 4}
#'  \item{Intermediate risk}{Score 5 to 6}
#'  \item{High risk}{Score >= 6}
#'  }
#' BACKGROUND:\cr
